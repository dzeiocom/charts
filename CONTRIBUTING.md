...
[DZEIO Code of Conduct](https://github.com/dzeiocom/crashhandler/blob/master/CODE_OF_CONDUCT.md).
By participating, you are expected to uphold this code. Please report unacceptable behavior to <contact.crashhandler@dze.io>.

## I Have a Question


You can ask them on the Github Repository, it is best to search for existing [Issues](https://github.com/dzeiocom/crashhandler/issues) that might help you.
...
- Open an [Issue](https://github.com/dzeiocom/crashhandler/issues/new).
...
- To see if other users have experienced (and potentially already solved) the same issue you are having, check if there is not already an issue report existing for your bug or error in the [bug tracker](https://github.com/dzeiocom/crashhandler/issues).
...
- Open an [Issue](https://github.com/dzeiocom/crashhandler/issues/new). (Since we can't be sure at this point whether it is a bug or not, we ask you not to talk about a bug yet and not to label the issue.)
...
- Perform a [search](https://github.com/dzeiocom/crashhandler/issues) to see if the enhancement has already been suggested. If it has, add a comment to the existing issue instead of opening a new one.
...
Enhancement suggestions are tracked as [GitHub issues](https://github.com/dzeiocom/crashhandler/issues).
...
- Create a Pull request here https://github.com/dzeiocom/crashhandler/compare by selecting your repository patch with our `master` branch _If it's not finished put WIP: before_
...
This guide is based on [Contribution Gen]((https://github.com/bttger/contributing-gen)) and was adapted by the community !